...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<Object> badRequestExceptionHandler(Exception ex, WebRequest request) {
    ...
    public ResponseEntity<Object> commonServerExceptionHandler(Exception ex, WebRequest request) {
        return new ResponseEntity<>(ErrorResponseDto.builder()
                .timestamp(Instant.now().toString())
